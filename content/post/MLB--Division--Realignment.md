...
Brute forcing through all 140,000 division configurations to find the optimal league setup was not a computationally viable option. The number of possible division configuration can be significantly reduced by pairing teams together that should almost certainly be in the optimized solution, combinations like NYY-NYM, LAD-LAA, OAK-SFG, and CHC-CHW.
